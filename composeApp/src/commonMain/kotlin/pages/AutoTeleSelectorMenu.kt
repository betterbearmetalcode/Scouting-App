...
class AutoTeleSelectorMenu(
    ...
    private var selectAuto = mutableStateOf(false)
    ...
    override fun resolve(interactionTarget: NavTarget, buildContext: BuildContext): Node =
        when (interactionTarget) {
            ...
            NavTarget.TeleScouting -> TeleMenu(buildContext, backStack,selectAuto, match, team, robotStartPosition, autoAmpNum, autoSpeakerNum, autoNotes, teleSpeakerNum, teleAmpNum, teleAmplified, teleTrapNum, selectedEndPos, teleNotes, lostComms)
