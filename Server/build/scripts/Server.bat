...
set DEFAULT_JVM_OPTS="--module-path" "%APP_HOME%\lib" "--module" "org.tahomaroboics.scoutingapp.server/org.tahomaroboics.scoutingapp.server.ScoutingServer"
...
@rem Execute Server
"%JAVA_EXE%" %JAVA_OPTS% %SERVER_OPTS% %DEFAULT_JVM_OPTS% %*
